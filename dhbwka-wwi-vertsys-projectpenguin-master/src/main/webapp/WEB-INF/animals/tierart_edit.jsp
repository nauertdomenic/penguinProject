    ...
    <jsp:attribute name="content">
        <form method="post" class="stacked">
            <div class="column">
                ...
                <label for="tierart_category">Spezies:</label>
                <div class="side-by-side">
                    <select name="tierart_category">
                        <option value="">Keine Spezies</option>

                        <c:forEach items="${categories}" var="category">
                            <option value="${category.id}" ${tierart_form.values["tierart_category"][0] == category.id.toString() ? 'selected' : ''}>
